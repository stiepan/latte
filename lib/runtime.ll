...
; <label>:5:                                      ; preds = %14, %0
  ...
  %7 = call i64 @getline(i8** %2, i64* %3, %struct._IO_FILE* %6)
...
; Function Attrs: noinline nounwind optnone uwtable
define void @error() #0 {
  %1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4, i32 0, i32 0))
